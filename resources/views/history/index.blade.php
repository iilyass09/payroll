    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
        <div class="card p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Total Slip Gaji</p>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 transition-colors">
                                ...
                                <td class="table-cell text-center whitespace-nowrap">
                                    <div class="flex items-center justify-center gap-1">
                                        <a href="{{ route('payroll.show', $import) }}" class="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/30 transition-colors">
    ...
    @else
        <div class="card">
            <div class="flex flex-col items-center justify-center py-20 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Belum ada riwayat slip gaji</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Upload slip gaji pertama Anda untuk memulai</p>
                <a href="{{ route('payroll.upload') }}" class="btn-primary mt-5">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.5v15m7.5-7.5h-15"/></svg>
                    Upload Slip Gaji Pertama
                </a>
            </div>
        </div>
    @endif
