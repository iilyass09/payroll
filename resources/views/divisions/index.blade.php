@push('topbar-left')
    <div>
        <h1 class="text-lg font-bold text-gray-900 dark:text-gray-100">Divisi</h1>
        <p class="text-xs text-gray-400 mt-0.5">Kelola data master divisi</p>
    </div>
@endpush

<x-app-layout title="Divisi">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div class="stat-card group">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Divisi Aktif</p>
        </div>
        ...
        <div class="stat-card group">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ number_format($stats['karyawan']) }}</p>
