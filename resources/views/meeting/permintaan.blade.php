<x-app-layout title="Permintaan Meeting">
    ...
    <div class="card">
        @if(!auth()->user()->isKaryawan())
        <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-50 dark:border-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 transition-colors">
                            ...
                            <td class="table-cell">
                                <div class="flex items-center gap-1">
                                    ...
                                    <button wire:click="setujui({{ $req->id }})"
                                    ...
                                    <button wire:click="tolak({{ $req->id }})"
